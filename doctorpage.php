...
<div class="bigofdoctor">
  <div class="login">
    <FORM>
        ...
        <td><button name="submit" type="submit" value="login" style="height: 50px; width: 305px;" formaction="diagnose.php">ตรวจรักษา</button></td>
        <td><button name="submit" type="submit" value="login" style="height: 50px; width: 305px;" formaction="historydiagnose.php">ประวัติการตรวจรักษา</button></td>
