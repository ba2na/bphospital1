...
<div class="bigofdoctor">
  <div class="login">
    <FORM>
        ...
        <form class="tableupdateuser" action="diagnose.php"method="post">
        <td><button name="submit" type="submit" value="login" style="height: 50px; width: 150px;" formaction="prescription.php">จ่ายยา</button></td>
        <td><button name="submit" type="submit" value="login" style="height: 50px; width: 150px;" formaction="historyprescription.php">ประวัติการจ่ายยา</button></td>
        <td><button name="submit" type="submit" value="login" style="height: 50px; width: 150px;" formaction="regismedicine.php">ลงทะเบียนยา</button></td>
        <td><button name="submit" type="submit" value="login" style="height: 50px; width: 145px;" formaction="allmed.php">ข้อมูลยา</button></td>
