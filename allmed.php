...
?>
  <tr>
    ...
    <td align="center"><a href="update.php?idmed=<?php echo $result["idmed"];?>">Edit</a></td>
    <td align="center"><a href="JavaScript:if(confirm('Confirm Delete?') == true){window.location='delete.php?idmed=<?php echo $result["idmed"];?>';}">Delete</a></td>
  </tr>
<?php
}
?>
